...
- Next: re-run **validation** on the corrected labels (the pass list will shift now that ~1,600 names moved out of Mean-Reverting and a real Trending bucket exists), then T-011 (stricter overall gate), T-010 (cache collisions).
